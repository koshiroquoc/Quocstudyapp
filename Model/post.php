<?php
	...
	@$id =  $_GET['id'];
	#các sản phẩm khác======================
	$select_field = "name_$lang,slug,id,thumb,photo,description_$lang,datecreate,view,attributes,code,status,wage";
	if($id!=''){
		...
		$item_photos = $db->query("select thumb,id,photo from #_cate_photo where shows=:shows and type=:type and id_cate=:id_cate order by number,datecreate desc");
