<?php
      $row_registered  =  $db->row("SELECT COUNT(*) as num FROM #_registered where view=0 ");
      ...
      $tong_count += $row_lienhe['num'] + $row_registered['num'];
?>
<div class="wrapper">
    ...
    <div class="userNav">
        <ul>
            ...
            <li class="ddnew"><a title=""><img src="Assets/images/icons/topnav/messages.png" alt="" /><span>Thông báo</span><span class="numberTop"><?=$tong_count?></span></a>
                <ul class="userMessage">
                    <li><a href="index.html?com=registered&act=man&type=registered" title="" class="sInbox"><span>Đăng ký tình nguyện viên</span> <span class="numberTop" style="float:none; display:inline-block"><?=$row_registered['num']?></span></a></li>
