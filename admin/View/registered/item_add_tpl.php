...
<form name="supplier" id="validate" class="form" action="index.html?com=registered&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		<div class="formRow">
			<label>Họ Tên : </label>
			<div class="formRight">
	...
	<div class="widget">
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="index.html?com=registered&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
