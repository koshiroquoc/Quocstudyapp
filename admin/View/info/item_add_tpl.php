	...
	<div class="formRow">
		...
		<?php if(in_array('thongtin',$config_open)){ $thongtin = json_decode($item['attributes'],true);?>
			<div class="formRow">
				...
				<div class="formRight">
					<input type="text" name="attributes[nam]" title="Nhập năm kinh nghiệm" class="tipS validate[required]" value="<?=$thongtin['nam']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
				<label>Đội ngũ</label>
				<div class="formRight">
					<input type="text" name="attributes[nguoi]" title="Nhập đội ngũ" class="tipS validate[required]" value="<?=$thongtin['nguoi']?>" />
				</div>
				<div class="clear"></div>
			</div>
			<div class="formRow">
				<label>Dự án</label>
				<div class="formRight">
					<input type="text" name="attributes[duan]" title="Nhập dự án" class="tipS validate[required]" value="<?=$thongtin['duan']?>" />
				</div>
				<div class="clear"></div>
			</div>
		<?php } ?>
