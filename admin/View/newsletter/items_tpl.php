...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
	...
	<tr align="center">
		...
		<td>
			<?php /*?> <a href="index.html?com=newsletter&act=edit&id=<?=$items[$i]['id']?>" title="" class="smallButton tipS" original-title="Xem"><img src="Assets/images/icons/dark/pencil.png" alt=""></a> <?php */?>
...
<?php /*?> 
	<div class="widget">
        ...
        <div class="formRow form">
			<label>Tiêu đề</label>
			<div class="formRight">
                <input type="text" name="name_vi" title="Nhập tiêu đề " id="name_vi" class="tipS validate[required]" value="<?=@$item['name_vi']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
			...
			<div class="ck_editor">
                <textarea id="content_vi" name="content_vi"><?=@$item['content_vi']?></textarea>
			</div>
			<div class="clear"></div>
		</div>
		<div class="formRow">
