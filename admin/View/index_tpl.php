...
$(function () {
    $('#container').highcharts({
        ...
        subtitle: {
            text: 'Phát triển bới: <a href="http://www.trungappstudy.com">Nguyễn Văn Trung</a>'
        },
        xAxis: {
            type: 'category',
            labels: {
...
<div class="widget">
   <div class="title"><h6>Chào mừng bạn đến với Administrator - HỆ THỐNG QUẢN TRỊ NỘI DUNG WEBSITE - Phát triển bởi:<a href="http://www.trungappstudy.com" target="_blank"><span style="color:#f00;">Nguyễn Văn Trung</span></a></h6><div class="clear"></div></div>
   <p>Nếu bạn có thắc mắc trong quá trình sử dụng, xin vui lòng gởi mail về địa chỉ <strong><a href="mailto:nvt170804@gmail.com">nvt170804@gmail.com</a></strong></p>
...
<script>
    ...
    <script>
        ...
        option = {
            ...
            title: {
                text: 'Device',
                subtext: 'Phát triển bởi Nguyễn Văn Trung',
                x: 'center'
            },
            toolbox: {
                show: true,
...
<script>
        ...
        option = {
            title: {
                text: 'Nation',
                subtext: 'Phát triển bởi Nguyễn Văn Trung',
                sublink: ' http://www.trungappstudy.com'
            },
            tooltip: {
                trigger: 'axis',
                axisPointer: {
