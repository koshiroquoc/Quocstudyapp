<?php 
	...
	defined( '_SITEURL_' ) ?:  define( '_SITEURL_', $Scheme.'://'.$_SERVER["SERVER_NAME"] ).'/hoctap';

	defined( '_BASEURL_' ) ?:  define( '_BASEURL_', $Scheme.'://'.$_SERVER["SERVER_NAME"].'/hoctap/' );
...
//Email
	...
	defined( 'C_EMAIL' ) ?:  define( 'C_EMAIL', 'contac@trungappstudy.com' );

	defined( 'C_PASS' ) ?:  define( 'C_PASS', 'ZsRDgC6tI' );
 ...
 //CK finder
	...
	$_SESSION['ckfinder_license'] = 'demo0.trungstudy.com';
